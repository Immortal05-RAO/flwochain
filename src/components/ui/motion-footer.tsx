...
.cinematic-footer-wrapper {
  ...
  --pill-bg-1: color-mix(in oklch, var(--foreground, #fff) 3%, transparent);
  --pill-bg-2: color-mix(in oklch, var(--foreground, #fff) 1%, transparent);
  --pill-shadow: color-mix(in oklch, var(--background, #000) 50%, transparent);
  --pill-highlight: color-mix(in oklch, var(--foreground, #fff) 10%, transparent);
  --pill-inset-shadow: color-mix(in oklch, var(--background, #000) 80%, transparent);
  --pill-border: color-mix(in oklch, var(--foreground, #fff) 8%, transparent);
  
  --pill-bg-1-hover: color-mix(in oklch, var(--foreground, #fff) 8%, transparent);
  --pill-bg-2-hover: color-mix(in oklch, var(--foreground, #fff) 2%, transparent);
  --pill-border-hover: color-mix(in oklch, var(--foreground, #fff) 20%, transparent);
  --pill-shadow-hover: color-mix(in oklch, var(--background, #000) 70%, transparent);
  --pill-highlight-hover: color-mix(in oklch, var(--foreground, #fff) 20%, transparent);
}
...
.footer-aurora {
  background: radial-gradient(
    circle at 50% 50%, 
    color-mix(in oklch, var(--primary, #4f8cff) 15%, transparent) 0%, 
    color-mix(in oklch, var(--secondary, #7c3aed) 15%, transparent) 40%, 
    transparent 70%
  );
}
...
.footer-giant-bg-text {
  ...
  color: transparent;
  -webkit-text-stroke: 1px color-mix(in oklch, var(--foreground, #fff) 5%, transparent);
  background: linear-gradient(180deg, color-mix(in oklch, var(--foreground, #fff) 10%, transparent) 0%, transparent 60%);
...
/* Metallic Text Glow */
.footer-text-glow {
  background: linear-gradient(180deg, var(--foreground, #fff) 0%, color-mix(in oklch, var(--foreground, #fff) 40%, transparent) 100%);
  -webkit-background-clip: text;
  -webkit-text-fill-color: transparent;
  background-clip: text;
  filter: drop-shadow(0px 0px 20px color-mix(in oklch, var(--foreground, #fff) 15%, transparent));
}
`;
